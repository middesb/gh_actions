...
//url := "https://api.github.com/repos/middesb/test002/actions/workflows/28229045/dispatches"
//var jsonStr = []byte(`{"ref":"main"}`) //[]byte(`{"ref":"main"}`)
//"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"
